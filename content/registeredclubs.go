...
// MarshalEditor writes a buffer of html to edit a RegisteredClub within the CMS
// and implements editor.Editable
func (r *RegisteredClub) MarshalEditor() ([]byte, error) {
	view, err := editor.Form(r,
		// Take note that the first argument to these Input-like functions
		// is the string version of each RegisteredClub field, and must follow
	...
	if err != nil {
		return nil, fmt.Errorf("Failed to render RegisteredClub editor view: %s", err.Error())
	}
...
func init() {
	item.Types["RegisteredClubs"] = func() interface{} { return new(RegisteredClub) }
}

func (r *RegisteredClub) String() string {
	return r.Name
}

func (r *RegisteredClub) Create(res http.ResponseWriter, req *http.Request) error {
	return nil
}

func (r *RegisteredClub) Approve(res http.ResponseWriter, req *http.Request) error {
	return nil
}

func (r *RegisteredClub) IndexContent() bool {
	return true
}
